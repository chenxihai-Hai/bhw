...
import static com.bhw.pay.common.SDKConstants.*;
...
public class SDKUtil {
    ...
    public static boolean sign(Map<String, String> data, String encoding) {
        ...
        if (StringUtils.isEmpty(version)) {
            logger.info("version must Not null");
            return false;
        }
    ...
    public static boolean signBySecureKey(Map<String, String> data, String secureKey,
        ...
        if (isEmpty(secureKey)) {
            logger.info("secureKey is empty");
            return false;
        }
        String signMethod = data.get(param_signMethod);
        if (isEmpty(signMethod)) {
            logger.info("signMethod must Not null");
            return false;
        }
    ...
    public static boolean signByCertInfo(Map<String, String> data,
        ...
        if (isEmpty(certPath) || isEmpty(certPwd)) {
            logger.info("CertPath or CertPwd is empty");
            return false;
        }
        String signMethod = data.get(param_signMethod);
...
//			}
    ...
    public static boolean copyFile(String srcFile, String destFile) {
        ...
        try {
            ...
            try {
                ...
                logger.info("Releases any system resources fail", ex);
            }
        }
        return flag;
    }
    ...
    public static boolean writeFile(String filePath, String fileContent,
        ...
        try {
            ...
            logger.info("WriteFile fail", e);
            return false;
        } catch (IOException ex) {
            logger.info("WriteFile fail", ex);
            return false;
        } finally {
            try {
                if (null != fout)
