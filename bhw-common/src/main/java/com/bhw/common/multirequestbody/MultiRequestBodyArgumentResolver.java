package  com.bhw.common.multirequestbody;
...
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        // 处理嵌套JSONArray转换错误的问题
        jsonObject = dealSubJsonArray(jsonObject);
    ...
    /**
     * 处理嵌套JSONArray转换错误的问题
     * eg1:"{\"author\":\"[{\"money\":500,\"name\":\"南派三叔\"},{\"money\":200,\"name\":\"孔二狗\"}]\",\"name\":\"网络文学\"}"
     * eg2:"{\"author\":[{\"money\":500,\"name\":\"南派三叔\"},{\"money\":200,\"name\":\"孔二狗\"}],\"name\":\"网络文学\"}"
     * eg2能正常解析，而eg1因为JSONArray外层多了“”会报异常
     * @param jsonObject
     * @return
     */
    private JSONObject dealSubJsonArray(JSONObject jsonObject){
        if (jsonObject != null) {
    ...
    private String getRequestBody(NativeWebRequest webRequest) {
        ...
        if (jsonBody == null) {
            ...
            if( contentType != null && contentType.indexOf("application/json") != -1){
                jsonBody = readAsChars(servletRequest);
