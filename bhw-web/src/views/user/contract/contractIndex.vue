<template>
    <div class="contractIndex">
        <el-row><h2 class="useTitle">技术合同/科技成果认定登记服务</h2></el-row>
...
<script>
    import contractUploading from "../contract/contractUploading";
    import contractAdmin from "../contract/contractAdmin";
    ...
    export default {
        ...
        data() {
            return {
                ...
                serverType:8,
                tabPosition: '0',
                subMenuComponents: ["contractUploading", "contractAdmin", "relation"],
                iconToggleFlag: 0
            };
        },
        methods: {
