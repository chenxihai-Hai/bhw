    ...
    <div class="Uploading" style="padding-left: 80px;">
        <el-form ref="productInfo" label-width="140px" :rules="rules" label-position="right" :model="productInfo">
            ...
            <el-form-item style="margin-top: 45px;">
                <el-button  class="btnColorOrg btnSave" @click="onSubmit(1)">保存为草稿</el-button>
                <el-button class="btnColorBlue btnUp" type="primary" @click="onSubmit(2)">上传发布</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
...
<script>
    import {getBussinessType, saveReleaseInfo,upFiscalTaxInfo,getFiscalTaxInfo} from "../../../api/user/fiscalTax";
    ...
    export default {
        ...
        created() {
            if(this.upInfoObj.id){
                getFiscalTaxInfo({id:this.upInfoObj.id}).then(response=>{
